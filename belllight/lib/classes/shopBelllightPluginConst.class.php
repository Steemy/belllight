...
class shopBelllightPluginConst
{
    ...
    public function getSettingsDefault()
    {
        return array(
            ...
            'thank'            => 'Спасибо за оставленную заявку!<br />
Наш оператор свяжется с вами в ближайшее время',
            'theme'            => 'Заказ обратного звонка c сайта',
            'templates_email'  => '<h1>Заказ обратного звонка с сайта {$nameSite}</h1>
<p>Пользователь <b>{$name}</b> заказал звонок на телефон <a href="tel:{$phone}"><b>{$phone}</b></a></p>
{if $mess}<p><b>Комментарий</b>: {$mess}</p>{/if}',
            'policy_checkbox'  => 0,
            'politika'         => 'Нажимая на кнопку, вы даете согласие на обработку своих<br />
